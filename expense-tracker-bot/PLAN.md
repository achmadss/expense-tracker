...
4. Next.js API downloads image and stores to Object Storage
5. Next.js API creates unprocessed expense record in Database
6. OCR Service extracts text from receipt images
...
| imageUrls | string[] | Array of stored image URLs |
